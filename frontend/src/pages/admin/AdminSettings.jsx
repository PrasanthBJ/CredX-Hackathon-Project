...
export default function AdminSettings() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-bold text-[#0F172A]">Placement Administrator Settings</h1>
        <p className="text-sm text-[#64748B] mt-1">Manage details and credentials for cell management coordinators.</p>
      </div>
