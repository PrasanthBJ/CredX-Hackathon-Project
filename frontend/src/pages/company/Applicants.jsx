...
import { Users, FileText, GraduationCap, Award, Calendar, ExternalLink, Save } from "lucide-react";
...
export default function Applicants() {
  ...
  if (loadingStudents) {
    return <div className="py-16"><Spinner label="Loading VTU Candidate Directory..." /></div>;
  }

  return (
    <div className="max-w-6xl mx-auto space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-bold text-[#0F172A]">Candidate Portfolio Directory</h1>
        <p className="text-sm text-[#64748B] mt-1">Review student resumes, CGPAs, graduation records, and override profile info.</p>
      </div>
              ...
              <div className="bg-white border border-[#E2E8F0] rounded-2xl p-5 shadow-sm hover:shadow-md transition-all h-full flex flex-col justify-between">
                <div>
                  ...
                  <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl p-3 text-xs space-y-2 mt-2">
                    <div className="flex justify-between"><span className="text-[#94A3B8]">Branch:</span><span className="font-semibold text-[#0F172A]">{student.branch || "N/A"}</span></div>
